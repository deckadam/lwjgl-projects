...
public class Fbo {
	...
	private boolean isMultisampled=false;
	...
	private void initialiseFrameBuffer(int type) {
		createFrameBuffer();
		if(isMultisampled) {
			createMultisampleColourBufferAttachment();
		}
		else {
	...
	private void createMultisampleColourBufferAttachment() {
		colourBuffer = GL30.glGenRenderbuffers();
		GL30.glBindFramebuffer(GL30.GL_RENDERBUFFER, colourBuffer);
	...
	public int getColourBuffer(){return colourBuffer;}
}
