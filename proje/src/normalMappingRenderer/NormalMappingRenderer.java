...
public class NormalMappingRenderer {
	...
	private void prepareTexturedModel(TexturedModel model) {
		...
		GL11.glBindTexture(GL11.GL_TEXTURE_2D, model.getMdlTexture().getNormalMap());
		shader.loadUseSpecularMap(texture.isHasSpecular());
	...
	private void prepareInstance(Entity entity) {
		Matrix4f transformationMatrix = Maths.createTransfromationMatrix(entity.getPosition(), entity.getRx(),
